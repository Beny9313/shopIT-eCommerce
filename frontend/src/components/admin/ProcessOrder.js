...
const ProcessOrder = ({ match }) => {
  ...
  useEffect(() => {
    ...
    if (isUpdated) {
      alert.success("Comanda a fost actualizată cu succes");
  ...
  return (
    <Fragment>
      <MetaData title={`Procesează Comanda # ${order && order._id}`} />
      <div className="row">
            ...
            {loading ? (
              ...
              <div className="row d-flex justify-content-around">
                <div className="col-12 col-lg-7 order-details">
                  <h2 className="my-5">Comanda # {order._id}</h2>
                  ...
                  <h4 className="my-4">Articole Comandă:</h4>
